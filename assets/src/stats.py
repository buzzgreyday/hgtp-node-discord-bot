            ...
            try:
                if current_time in times:
                    ...
                    for i, row in filtered_df.iterrows():
                        ...
                        print("Most effective earner:", dag_address_earnings_above.dag_address_sum.nlargest())
                        ...
                        print("Missing out on", dag_address_earnings_above.dag_address_sum.mean() - row.dag_address_sum,
                              "(average)")
                        print("Missing out on", dag_address_earnings_above.dag_address_sum.nlargest() - row.dag_address_sum,
